...
public class SQLiteScheme {
    ...
    /**
     * The base interface for any global table (table that sync with server)
     * in database.
     * */
    ...
    /**
     * The base interface for any table in database which support different
     * localization.
     * */
    ...
    /**
     * The base interface for any table in database which includes location
     * information.
     * */
    public interface LocationTable {
        /**
         * The location of a row object in WGS84 format (for example
         * {@code 50.083698,45.407367}).
         * <p>Type: TEXT</p>
         * */
        // @Column(Cursor.FIELD_TYPE_STRING)
    ...
    /**
     * The base interface for any table in database which includes direct
     * links to popular map services.
     * */
    ...
    /**
     * The base interface for any table in database which includes link
     * to a web-site.
     * */
    ...
    /**
     * The base interface for any table in database which includes the name
     * of stock keeping unit.
     * */
    ...
    public static class TableLocale {
        ...
        /**
         * The locale code contains language and country/region code. For
         * example: {@code ru_RU}, {@code en_US}, {@code cs_rCZ}. By default
         * we can use only language code in app.
         * <p>Type: TEXT</p>
         * */
        // @Column(Cursor.FIELD_TYPE_STRING)
        ...
        /**
         * The "enabled" flag. It means enabled locale for user, or not. By
         * default, it's {@code true}.
         * <p>Type: BOOLEAN</p>
         * */
    ...
    /**
     * The view (virtual table) contains information about available to the
     * user locales.
     * */
    public static class ViewLocale extends TableLocale {
        ...
        public static final String SQL_CREATE =  "CREATE VIEW "
